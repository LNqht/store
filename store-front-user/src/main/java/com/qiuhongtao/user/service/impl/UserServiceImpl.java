...
import com.qiuhongtao.user.constants.UserConstants;
import com.qiuhongtao.user.mapper.UserMapper;
import com.qiuhongtao.user.service.UserService;
import com.qiuhongtao.utils.MD5Util;
...
public class UserServiceImpl implements UserService {
    ...
    public Object update(User user) {
        ...
        if (total == 0){
           //密码不同,已经修改! 新密码需要加密
           user.setPassword(MD5Util.encode(user.getPassword()+ com.qiuhongtao.constants.UserConstants.USER_SLAT));
        }
